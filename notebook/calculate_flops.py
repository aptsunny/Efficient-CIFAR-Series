...
if __name__ == '__main__':
    ...
    for node in nodes:
        ...
        if op == 'Convolution':
            ...
            total_flops += out_shape_produt * product(arg_params[layer_name[:-4] + '_weight'].shape) * data_shapes[0][1][0]
        ...
        if op == 'FullyConnected':
            total_flops += product(arg_params[layer_name[:-4] + '_weight'].shape) * data_shapes[0][1][0]
